...
def start(request):
    try:
        ...
        response_url = request.build_absolute_uri("/oneclick-mall/finish")
        ...
        return render(request, "oneclick_mall/start.html", context)
...
def delete(request):
    try:
        ...
        return render(request, "oneclick_mall/delete.html")
...
def authorize(request):
    try:
        ...
        return render(request, "oneclick_mall/authorize.html", context)
...
def status(request):
    try:
        ...
        return render(request, "oneclick_mall/status.html", {"response_data": resp})
    except Exception as e:
        return render(request, ERROR_TEMPLATE, {"error": str(e)})
...
def refund(request):
    try:
        ...
        return render(request, "oneclick_mall/refund.html", {"response_data": resp, "buy_order": buy_order})
...
def capture(request):
    try:
        ...
        return render(request, "oneclick_mall/capture.html", context)
