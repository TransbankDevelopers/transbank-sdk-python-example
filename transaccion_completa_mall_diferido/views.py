...
SESSION_DETAILS_KEY = "transaccion_completa_mall_diferido_details"
    ...
    return [
        {
            ...
            "commerce_code": IntegrationCommerceCodes.TRANSACCION_COMPLETA_MALL_DEFERRED_CHILD1,
            "buy_order": f"O-{secrets.randbelow(10001)}",
        },
        {
            "amount": secrets.randbelow(1001) + 1000,
            "commerce_code": IntegrationCommerceCodes.TRANSACCION_COMPLETA_MALL_DEFERRED_CHILD2,
            "buy_order": f"O-{secrets.randbelow(10001)}",
        },
    ]
...
@require_GET
def index(request):
    return render(request, "transaccion_completa_mall_diferido/index.html")
...
def create(request):
    ...
    try:
        ...
        return render(request, "transaccion_completa_mall_diferido/create.html", context)

    except Exception as e:
        logger.error(f"Error en Transacción Completa Mall Diferido - Create: {str(e)}")
...
def installments(request):
    ...
    try:
        ...
        return render(request, "transaccion_completa_mall_diferido/installments.html", context)

    except Exception as e:
        logger.error(f"Error en Transacción Completa Mall Diferido - Installments: {str(e)}")
        return render(request, ERROR_TEMPLATE, {"error": str(e)})
...
def commit(request):
    ...
    try:
        ...
        return render(request, "transaccion_completa_mall_diferido/commit.html", context)

    except Exception as e:
        logger.error(f"Error en Transacción Completa Mall Diferido - Commit: {str(e)}")
        return render(request, ERROR_TEMPLATE, {"error": str(e)})
...
def capture(request):
    ...
    try:
        ...
        return render(request, "transaccion_completa_mall_diferido/capture.html", context)

    except Exception as e:
        logger.error(f"Error en Transacción Completa Mall Diferido - Capture: {str(e)}")
        return render(request, ERROR_TEMPLATE, {"error": str(e)})
...
def status(request):
    ...
    try:
        ...
        return render(request, "transaccion_completa_mall_diferido/status.html", context)

    except Exception as e:
        logger.error(f"Error en Transacción Completa Mall Diferido - Status: {str(e)}")
        return render(request, ERROR_TEMPLATE, {"error": str(e)})
...
def refund(request):
    ...
    try:
        ...
        return render(request, "transaccion_completa_mall_diferido/refund.html", context)

    except Exception as e:
        logger.error(f"Error en Transacción Completa Mall Diferido - Refund: {str(e)}")
        return render(request, ERROR_TEMPLATE, {"error": str(e)})
